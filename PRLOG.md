...
- deps: update dependency toolkit to v6.3.0(pr [#798])
- deps: update rust crate chrono to 0.4.45(pr [#796])
- deps: update rust crate uuid to 1.23.3(pr [#797])
...
- deps: lock file maintenance(pr [#802])
- deps: update rust crate rand to 0.10.2(pr [#805])
- deps: update rust crate uuid to 1.24.1(pr [#806])
- deps: lock file maintenance(pr [#808])
- deps: update dependency toolkit to v7.4.0(pr [#809])
- deps: update rust crate uuid to 1.26.1(pr [#810])
- deps: lock file maintenance(pr [#811])
...
- ci-ignore main in test_doc_build(pr [#787])

### Fixed

- deps: update rust crate chrono to 0.4.44(pr [#785])
- deps: update rust crate uuid to 1.22.0(pr [#786])
...
- deps: update dependency toolkit to v3(pr [#773])
- deps: update rust crate uuid to 1.19.0(pr [#772])

## [0.4.55] - 2025-11-21

### Fixed

- deps: update dependency toolkit to v2.16.0(pr [#770])

## [0.4.54] - 2025-10-21

### Fixed

- deps: update dependency toolkit to v2.13.4(pr [#769])
...
- Dependencies: update actions/upload-artifact action to v4.4.3(pr [#693])
...
- Update github/codeql-action digest to d05538f
...
[#769]: https://github.com/jerus-org/mockd/pull/769
[#770]: https://github.com/jerus-org/mockd/pull/770
...
[#798]: https://github.com/jerus-org/mockd/pull/798
...
[#802]: https://github.com/jerus-org/mockd/pull/802
[#805]: https://github.com/jerus-org/mockd/pull/805
[#806]: https://github.com/jerus-org/mockd/pull/806
[#808]: https://github.com/jerus-org/mockd/pull/808
[#809]: https://github.com/jerus-org/mockd/pull/809
[#810]: https://github.com/jerus-org/mockd/pull/810
[#811]: https://github.com/jerus-org/mockd/pull/811
...
[0.4.53]: https://github.com/jerus-org/mockd/compare/v0.4.52...v0.4.53
